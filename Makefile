...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Fri Apr 18 14:37:59 2014
# Project:  tictactoe.pro
# Template: app
# Command: /home/xamists/Downloads/qt-everywhere-opensource-src-4.8.5/bin/qmake -spec /usr/local/Trolltech/Qt-4.8.5/mkspecs/linux-g++ -o Makefile tictactoe.pro
#############################################################################
...
AR            = ar cqs
RANLIB        = 
QMAKE         = /home/xamists/Downloads/qt-everywhere-opensource-src-4.8.5/bin/qmake
TAR           = tar -cf
COMPRESS      = gzip -9f
COPY          = cp -f
SED           = sed
...
Makefile: tictactoe.pro  /usr/local/Trolltech/Qt-4.8.5/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.8.5/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/gcc-base.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/gcc-base-unix.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/local/Trolltech/Qt-4.8.5/mkspecs/linux-g++ -o Makefile tictactoe.pro
